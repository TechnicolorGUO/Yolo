...
if __name__ == '__main__':
    ...
    data_yaml_path = '/home/wheeltec/PycharmProjects/PythonProject/Yolo/IC_AI_Model_Training_02.yaml'  # Replace with your dataset YAML file path
    ...
    train_yolov5(
        ...
        name='IC_AI_model_02',  # Name of the training experiment
