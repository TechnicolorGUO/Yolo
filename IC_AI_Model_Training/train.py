...
"""
Train a YOLOv5 model on a custom dataset. Models and IC_AI_DataSet download automatically from the latest YOLOv5 release.
...
def train(hyp, opt, device, callbacks):
    """
    Train a YOLOv5 model on a custom dataset using specified hyperparameters, options, and device, managing IC_AI_DataSet,
    ...
    Models and IC_AI_DataSet download automatically from the latest YOLOv5 release.
