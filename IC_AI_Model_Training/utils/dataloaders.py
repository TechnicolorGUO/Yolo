...
def create_dataloader(
    ...
    """Creates and returns a configured DataLoader instance for loading and processing image IC_AI_DataSet."""
    if rect and shuffle:
...
class HUBDatasetStats:
    ...
    def __init__(self, path="coco128.yaml", autodownload=False):
        """Initializes HUBDatasetStats with optional auto-download for IC_AI_DataSet, given a path to dataset YAML or ZIP
        file.
        """
