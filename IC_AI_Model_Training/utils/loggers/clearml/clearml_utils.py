...
class ClearmlLogger:
    """
    Log training runs, IC_AI_DataSet, models, and predictions to ClearML.
    ...
    By providing additional command line arguments to train.py, IC_AI_DataSet, models and predictions can also be logged.
    """
    ...
    def __init__(self, opt, hyp):
        ...
        if self.clearml:
            ...
            if opt.data.startswith("clearml://"):
                ...
                # names, nc (number of classes), test, train, val (all three relative paths to ../IC_AI_DataSet)
