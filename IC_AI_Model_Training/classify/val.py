...
Usage:
    ...
    $ python classify/val.py --weights yolov5m-cls.pt --data ../IC_AI_DataSet/imagenet --img 224  # validate ImageNet
...
def run(
    data=ROOT / "../IC_AI_DataSet/mnist",  # dataset dir
...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "../IC_AI_DataSet/mnist", help="dataset path")
